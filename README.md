...
public class qgendaneu {
	public static String getValidDate(Scanner scanner, String dateType, String st_date) {
		String datePattern = "\\d{2}/\\d{2}/\\d{4}"; // Regex for MM/DD/YYYY format
		String date;
